...
<%
  Connection connection = null;
   ...
   String sql="select * from doctor_table where id=2";
   try{
...
<table>
 ...
 <select>
  <option value="mon1">Fri 2 PM - 3 PM</option>
  <option value="mon2">Fri 3 PM - 4 PM</option>
  <option value="mon3">Fri 4 PM - 5 PM</option>
  <option value="mon4">Wed 5 PM - 6 PM</option>
</select> 
