<%@page import="com.pavan.conversation.Utility.MySQLConnection"%>
...
<%
  Connection connection = null;
   ...
   String sql="select * from doctor_table where id=4";
   try{
...
<table>
 ...
 <select>
  <option value="sat1">Sat 2 PM - 3 PM</option>
  <option value="sat2">Sat 3 PM - 4 PM</option>
  <option value="sat3">Sat 4 PM - 5 PM</option>
  <option value="sun1">Sun 2 PM - 3 PM</option>
  <option value="sun2">Sun 3 PM - 4 PM</option>
</select> 
